...
[glink_config show_time="360" show_effect="hlChoiceFadeInStagger" show_delay="520" show_easing="cubic-bezier(0.25,0.1,0.25,1)" select_time="560" select_effect="hlChoiceFadeOutHold" select_easing="ease-in" reject_time="560" reject_effect="hlChoiceFadeOutHold" reject_easing="ease-in"]
[endmacro]

[macro name=choice]
[eval exp="tf.choice_current_y = tf.choice_y + (tf.choice_index * tf.choice_gap)"]
[eval exp="tf.choice_show_delay = 520 + (tf.choice_index * 90)"]
