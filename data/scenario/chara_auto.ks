...
[eval exp="tf.default_width_map = {'恵':905,'拓海':970,'龍也':1024,'綾香':890,'綾香の母':927,'翔太':1024,'響子':927,'高田':960}"]
; 龍也を画面上端（top=0）に置き、従来の top 差を全員で保って身長差を表現する。
[eval exp="tf.default_top_map = {'恵':46,'拓海':26,'龍也':0,'綾香':42,'綾香の母':36,'翔太':15,'響子':30,'高田':20}"]
