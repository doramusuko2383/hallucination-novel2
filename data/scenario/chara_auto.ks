...
[eval exp="tf.default_width_map = {'恵':905,'拓海':940,'龍也':1024,'綾香':890,'綾香の母':880,'翔太':980,'響子':927,'高田':960}"]
; 龍也を画面上端（top=0）に置き、従来の top 差を全員で保って身長差を表現する。
[eval exp="tf.default_top_map = {'恵':46,'拓海':32,'龍也':0,'綾香':42,'綾香の母':50,'翔太':20,'響子':60,'高田':40}"]
