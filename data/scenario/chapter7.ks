...
玄関のチャイムが鳴ったとき、恵はわずかに息を止めた。[l]けれどモニターに映った拓海を見て、自分で鍵を開けに行った。[p]
...
その一度、二人はいつものファミレスで、調査資料の代わりに参考書を広げた。[p]

恵が玄関のチャイムに身構えることも、拓海が誰かの手に触れるのをためらうことも、すぐにはなくならなかった。[p]

それでも、分からない問題をメッセージで交換する日を重ねるうちに、何も起きない時間の方が少しずつ長くなっていった。[p]

ある日、拓海が教員養成課程のある大学のページを眺めていると、恵は理由を尋ねず、募集要項のリンクだけを送ってくれた。[p]

拓海もまた、法学部の過去問題集を恵へ黙って差し出した。[l][r]言葉にするにはまだ早い将来を、二人はそうやって互いの机の上へ置き始めていた。[p]
...
綾香の足元には、使い込まれたスケッチブックの角が鞄から覗いていた。[l]拓海はそれを見て、もう一度だけ静かに息を吐いた。[p]
[chara_hide_all]
...
触れていいか尋ねる代わりに、拓海は手のひらを上にして、テーブルの中央へゆっくり差し出した。[p]

恵はその手と拓海の顔を交互に見たあと、自分から指先を重ねた。[p]
[fadeoutbgm time=3000]
[auto_chara name="拓海" face="level3_normal"]
