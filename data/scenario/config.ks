...
;	メニューボタン非表示
	...
	tf.config_x       = [400, 454, 508, 562, 616, 670, 724, 778, 832, 886, 940]; // X座標（共通）
...
;	黒ガラス調CONFIG見出し・項目ラベル
	...
	[ptext layer="fix" fix="true" name="config_help_text" text="MESSAGE SPEED  SLOW / NORMAL / FAST" x="304" y="359" size="9" color="0xaeb8c0"]
	[ptext layer="fix" fix="true" name="config_scale_line" text="────────────────────────" x="404" y="350" size="9" color="0x8fa1ad"]
	...
	[ptext layer="fix" fix="true" name="config_help_text" text="AUTO WAIT  SLOW / NORMAL / FAST" x="304" y="419" size="9" color="0xaeb8c0"]
	[ptext layer="fix" fix="true" name="config_scale_line" text="────────────────────────" x="404" y="410" size="9" color="0x8fa1ad"]
